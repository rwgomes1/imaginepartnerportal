...
if (!defined('APP_URL')) {
    define('APP_URL', rtrim(app_config_value('APP_URL', 'https://your-domain.example'), '/'));
}

if (!defined('MAIL_FROM')) {
    define('MAIL_FROM', app_config_value('MAIL_FROM', 'no-reply@your-domain.example'));
}

if (!defined('DB_DSN')) {
    define('DB_DSN', app_config_value('DB_DSN', 'mysql:host=localhost;dbname=imagine_partnerportal;charset=utf8mb4'));
}
